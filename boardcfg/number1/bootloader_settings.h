 ...
 *
 * number1/bootloader_settings.h
 * Copyright (C) 2015 Simon Newton
 */

#ifndef BOARDCFG_NUMBER1_BOOTLOADER_SETTINGS_H_
#define BOARDCFG_NUMBER1_BOOTLOADER_SETTINGS_H_
 ...
 */
#define SWITCH_PORT_CHANNEL PORT_CHANNEL_F

/**
 * @brief The port pin of the switch that controls bootloader mode.
 */
#define SWITCH_PORT_BIT PORTS_BIT_POS_5
...
#endif  // BOARDCFG_NUMBER1_BOOTLOADER_SETTINGS_H_
